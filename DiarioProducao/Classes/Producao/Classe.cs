...
namespace DiarioProducao.Classes.Producao
{
  public class Classe
  {
    ...
    private void CriaColunas ( )
    {
      ...
      _colunas.Add ( new Coluna ( 2, "codigo_empresa", nameof( Empresa ), typeof ( String ), false, false, false ) );
      ...
      _colunas.Add ( new Coluna ( 5, "codigo_turno", nameof( Turno ), typeof ( String ), false, false, true ) );
