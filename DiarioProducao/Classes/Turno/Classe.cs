...
namespace DiarioProducao.Classes.Turno
{
  public class Classe
  {
    ...
    private void CriaColunas ( )
    {
      ...
      _colunas.Add ( new Coluna ( 1, "codigo_empresa", nameof( Empresa ), typeof ( String ), false, true, false ) );
      _colunas.Add ( new Coluna ( 2, "codigo_turno_tipo", "Tipo Turno", typeof ( String ), false, true, true ) );
      _colunas.Add ( new Coluna ( 3, "codigo_turno", nameof( Turno ), typeof ( String ), false, true, true ) );
