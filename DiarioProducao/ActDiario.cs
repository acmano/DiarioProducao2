...
namespace DiarioProducao
{
  ...
  public class ActDiario : Activity
  {
    ...
    private void SetaParametros(ref Intent intent, Detalhe linhaSelecionada)
    {
    ...
    private void AtualizaVersao()
    {
      ...
      AlteraVersao.TrocaVersao( this, "", ref lAtualizaVersao );
    }
    ...
    {
      _listaProducao = new ListaProducao( this, _acessoSql, _codEmpresa, _datProducao.Text, Convert.ToInt64( _txtDenLinha.Tag ), Convert.ToInt64( _txtDenTurno.Tag ) );
      return ( true );
    }
